                ...
                <div class="flex flex-col md:grid md:grid-cols-[minmax(150px,200px)_1fr] gap-2 md:gap-4">
                    <div class="flex space-x-4">
                        <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 1C14.97 1 19 5.03 19 10C19 14.97 14.97 19 10 19C5.03 19 1 14.97 1 10C1 5.03 5.03 1 10 1ZM10 3C6.13 3 3 6.13 3 10C3 13.87 6.13 17 10 17C13.87 17 17 13.87 17 10C17 6.13 13.87 3 10 3ZM10 5C11.66 5 13 6.34 13 8C13 9.66 11.66 11 10 11C8.34 11 7 9.66 7 8C7 6.34 8.34 5 10 5Z" stroke="#7D7D7D" fill="none"/>
                        </svg>
                        <span>Progress</span>
                    </div>
                    <div class="space-y-2">
    ...
    `}renderEditTask(e){const t=document.querySelector('meta[name="csrf-token"]').getAttribute("content");console.log(t);const o=document.getElementById("modalEdit"),s=document.getElementById("modalEditBody"),a=`
        <form action="/tasks/${e.id}" method="POST" enctype="multipart/form-data">
            ...
            <div class="py-2 px-8 space-y-3">
                ...
                <!-- Progress Persentase -->
                <div class="space-y-1">
                    <label class="block text-sm text-gray-700" for="persentase_progress_task">Progress (%)</label>
                    ...
                    <div id="progress-error" class="text-red-500 text-xs hidden">Progress harus antara 0-100%</div>
                </div>
        ...
        <script>
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                const progressInput = document.getElementById('persentase_progress_task');
                const value = parseInt(progressInput.value);
                
                if (value < 0 || value > 100 || isNaN(value)) {
                    e.preventDefault();
                    validateProgress(progressInput);
                    return false;
                }
            });
        <\/script>
