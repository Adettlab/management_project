        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full pb-2 mb-3 gap-4">
            ...
            @if ($errors->has('error'))
                <div class="flex justify-center items-center mx-4">
                    <div class="flex flex-row justify-center items-center bg-red-100 rounded-lg p-2 text-xs text-red-700 w-fit whitespace-nowrap"
                        role="alert">
            ...
            <div class="w-full lg:w-[30%] flex flex-col sm:flex-row justify-end gap-2 sm:space-x-4 sm:gap-0">
                ...
                @if (!(auth()->user()->role === 'admin' || auth()->user()->employee->role->name === 'KEPALA PUSTIK'))
                    ...
                    @endif
                @endif
                {{-- Transfer Task Button - Hanya untuk Admin dan KEPALA PUSTIK --}}
                @if ($canTransfer)
                    <div class="w-full sm:w-1/3">
                ...
                {{-- See All Task Button - Hanya untuk Admin dan KEPALA PUSTIK --}}
                @if ($canSeeAllTask)
                    <div class="w-full sm:w-1/3">
            ...
            <div class="flex flex-col lg:flex-row lg:space-x-4 w-full space-y-4 lg:space-y-0" id="kanban-board">
                ...
                <div class="w-full lg:w-1/4 h-fit pb-8">
                    <div class="bg-white rounded-lg">
                        ...
                        <div id="in_progress" class="p-4 connectedSortable min-h-[200px]"
                            ondrop="taskManager.drop(event)" ondragover="taskManager.allowDrop(event)">
                        </div>
                    </div>
                </div>
...
@if ($canCreate)
    ...
    <div id="modalCreate"
        ...
        <!-- Modal Content -->
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4 h-[460px] overflow-y-auto">
            <!-- Modal Header -->
